...
export default function Ingrediente({
  ...
  var [categoriaPrincipal, setCategoriaPrincipal] =
    useState(categoriaPrincipal);
  ...
  return (
    <div className="row w-100 align-items-center text-center border-bottom mt-3 py-3">
      <div className="col-md-9 col-12 d-flex mb-4 mb-md-0 flex-wrap">
        ...
        <label id="categoriaPrincipal" className="col-5 col-md-2 my-auto">
          {categoriaPrincipal}
        </label>
        <p
          id="descricao"
        ...
        <label
          id="qtd"
          className="col-6 col-md-2 my-auto text-end text-md-center"
        >
          {qtd}
        </label>
        <label
          id="medida"
          className="col-6 col-md-1 my-auto text-start text-md-center"
        >
          {medida}
        </label>
      </div>
      ...
      <div className="col-12 col-md-3">
        <div className="row d-flex justify-content-center">
          <button
            className="col-3 mx-1 btn btn-primary"
            onClick={() => {
              atualizarQtdDB(id, Number(qtd + variacao));
              setQtd(qtd + variacao);
            }}
          >
            +
          ...
          <button
            ...
            onClick={() => {
              if (qtd > variacao - 1) {
                atualizarQtdDB(id, qtd - variacao);
                setQtd(qtd - variacao);
              }
            }}
          >
