    ...
    <div className={`Cabecalho ${fundo}`}>
      ...
      <div className="rightSide">
        ...
        <svg
          ...
          height="50"
          fill="#ff2b2b"
          className="bi bi-bookmark-star-fill icone-favoritar"
          viewBox="0 0 16 16"
        >
          <path
            fill-rule="evenodd"
        ...
        <svg
          ...
          height="50"
          fill="#ff2b2b"
          className="bi bi-funnel-fill icone-filtro"
          viewBox="0 0 16 16"
        ...
        >
          <svg
            ...
            height="50"
            fill="#ff2b2b"
            className="icone-home bi bi-house-fill"
            viewBox="0 0 16 16"
          >
        ...
        <div id="filtro-estoque">
          ...
          <div className="filtrar-nome">
            <img
              src={nomeFiltro}
              className="imagem-filtro-pesquisa"
              onclick=""
            />
          ...
          <div className="filtrar-ingrediente">
            <img
              src={ingredienteFiltro}
              className="imagem-filtro-ingrediente"
              onclick=""
            />
          ...
          <div className="filtrar-categoria">
            <img
              src={categoriaFiltro}
              className="imagem-filtro-categoria"
              onclick=""
            />
